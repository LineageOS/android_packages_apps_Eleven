...
public abstract class SlidingPanelActivity extends BaseActivity {
    ...
    private FrameLayout mPlaypPauseContainer;
    private ImageView mBottomActionBarAlbumArt;
    ...
    protected void initBottomActionBar() {
        ...
        // playing
        mBbottomActionBar.setOnClickListener(mOpenNowPlaying);
    }
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mPlaypPauseContainer = findViewById(R.id.play_pause_container);
        mBottomActionBarAlbumArt = findViewById(R.id.bottom_action_bar_album_art);
    ...
    private void collapseAllPanels() {
        Panel panel = getCurrentPanel();
            switch (panel) {
                case Browse:
                    mFirstPanel.setSlidingEnabled(false);
                    mPlaypPauseContainer.setVisibility(View.GONE);
                    mPottomActionBarAlbumArt.setVisibility(View.GONE);
                    break;
                default:
                case MusicPlayer:
                    showPanel(Panel.Browse);
    ...
    private void checkQueueStatus() {
        ...
        if (MusicUtils.getQueue() != null) {
            ...
            mPottomActionBarAlbumArt.setVisibility(View.VISIBLE);
        } else {
