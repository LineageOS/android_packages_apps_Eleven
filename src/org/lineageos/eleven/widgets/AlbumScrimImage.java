...
public class AlbumScrimImage extends FrameLayout {
    private static final int COLOR_GREY_50 = 0x7f000000;
    ...
    public void setGradientDrawable(GradientDrawable gradientDrawable) {
        // set scrim view to 50% grey to prevent full white layouts
        final ColorDrawable scrimDrawable = new ColorDrawable(COLOR_GREY_50);
