...
public final class MusicUtils {
    ...
    public static long getIdForPlaylist(final Context context, final String name) {
        ...
        try (Cursor cursor = context.getContentResolver().query(Playlists.getContentUri(MediaStore.VOLUME_EXTERNAL),
    ...
    public static String getNameForPlaylist(final Context context, final long id) {
        try (Cursor cursor = context.getContentResolver().query(
                Playlists.getContentUri(MediaStore.VOLUME_EXTERNAL), new String[]{PlaylistsColumns.NAME},
    ...
    public static long getIdForArtist(final Context context, final String name) {
        ...
        try (Cursor cursor = context.getContentResolver().query(
                MediaStore.Audio.Artists.getContentUri(MediaStore.VOLUME_EXTERNAL), new String[]{BaseColumns._ID},
    ...
    public static int getSongCountForAlbumInt(final Context context, final long id) {
        ...
        Uri uri = ContentUris.withAppendedId(MediaStore.Audio.Albums.getContentUri(MediaStore.VOLUME_EXTERNAL), id);
