...
public class MusicPlaybackService extends MediaBrowserService
    ...
    public void onLoadChildren(@NonNull String parentId,
        ...
        try (Cursor c = getContentResolver().query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI,
                ...
                null, null)) {
            while (c.moveToNext()) {
                String albumName = c.getString(c.getColumnIndexOrThrow(MediaStore.Audio.Media.ALBUM));
                long albumId = c.getLong(c.getColumnIndexOrThrow(MediaStore.Audio.Media.ALBUM_ID));
                Bitmap bitmap = mImageFetcher.getArtwork(albumName, albumId, true).getBitmap();
                MediaDescription mediaDesc = new MediaDescription.Builder()
                        .setTitle(c.getString(c.getColumnIndexOrThrow(MediaStore.Audio.Media.TITLE)))
                        .setMediaId(c.getString(c.getColumnIndexOrThrow(MediaStore.Audio.Media._ID)))
                        .setIconBitmap(bitmap)
                        .build();
                mediaItems.add(new MediaBrowser.MediaItem(mediaDesc, MediaBrowser.MediaItem.FLAG_PLAYABLE));
            }
        }
