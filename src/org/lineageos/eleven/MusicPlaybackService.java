...
public class MusicPlaybackService extends MediaBrowserServiceCompat {
    ...
    private static class QueueUpdateTask extends AsyncTask<Void, Void, List<MediaSessionCompat.QueueItem>> {
        ...
        private final WeakReference<MediaSessionCompat> mMediaSessionRefrence;
        private final long[] mQueue;

        QueueUpdateTask(final Context context, final MediaSessionCompat mediaSessionCompat,
                final long[] queue) {
            mContextReference = new WeakReference<>(context);
            mMediaSessionRefrence = new WeakReference<>(mediaSessionCompat);
        ...
        protected List<MediaSessionCompat.QueueItem> doInBackground(Void... params) {
            ...
            if (mMediaSessionRefrence == null || mMediaSessionRefrence.get() == null) {
                return null;
            }
        ...
        protected void onPostExecute(List<MediaSessionCompat.QueueItem> items) {
            final MediaSessionCompat mediaSessionCompat = mMediaSessionRefrence.get();
