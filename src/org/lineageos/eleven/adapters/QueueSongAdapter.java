 ...
 */
public class QueueSongAdapter extends RecyclerView.Adapter<MusicHolder> implements IPopupMenuCallback {
    ...
    public void move(int startPosition, int endPosition) {
        mHandler.post(() -> {
            ...
            int addIndex = endPosition > startPosition
                    ? endPosition - 1
                    : endPosition;
            mSongs.add(addIndex, moving);
